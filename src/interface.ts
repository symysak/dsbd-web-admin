...
export const DefaultGroupDetailDataArray: GroupDetailData[] = [
  DefaultGroupDetailData,
]
...
export const DefaultServiceDetailDataArray: ServiceDetailData[] = [
...
export const DefaultTokenDetailDataArray: TokenDetailData[] = [
  DefaultTokenDetailData,
]
