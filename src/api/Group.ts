...
export function Put(
  ...
  return axios
    .put(restfulApiConfig.apiURL + '/group/' + id, data, {
      headers: {
...
export function DeleteSubscription(
  ...
  return axios
    .delete(restfulApiConfig.apiURL + '/group/' + id + '/subscription', {
      headers: {
        'Content-Type': 'application/json',
        ACCESS_TOKEN: sessionStorage.getItem('AccessToken')!,
      },
...
export function Get(id: string): Promise<{ error: string; data: any }> {
  return axios
    .get(restfulApiConfig.apiURL + '/group/' + id, {
      headers: {
        'Content-Type': 'application/json',
        ACCESS_TOKEN: sessionStorage.getItem('AccessToken')!,
      },
...
export function GetAll(): Promise<{ error: string; data: any }> {
  return axios
    .get(restfulApiConfig.apiURL + '/group', {
      headers: {
        'Content-Type': 'application/json',
        ACCESS_TOKEN: sessionStorage.getItem('AccessToken')!,
      },
